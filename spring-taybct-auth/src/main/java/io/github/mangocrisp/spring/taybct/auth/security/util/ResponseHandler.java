...
public class ResponseHandler implements AuthenticationFailureHandler
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        if (authentication instanceof CustomizeTokenAuthenticationToken) {
            CustomizeTokenAuthenticationToken customizeTokenAuthenticationToken = (CustomizeTokenAuthenticationToken) authentication;
    ...
    protected Authentication createSuccessAuthentication(Authentication authentication) {
        ...
        if (authentication instanceof CustomizeTokenAuthenticationToken) {
            CustomizeTokenAuthenticationToken token = (CustomizeTokenAuthenticationToken) authentication;
