package io.github.mangocrisp.spring.taybct.admin.file.dto.add;
...
@AllArgsConstructor
@ToString
@Schema(description = "【文件管理】新增对象")
public class SysFileAddDTO implements Serializable, ModelConvertible<SysFile> {
